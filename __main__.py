...
def main():
    ...
    for df in filtered_dfs_dict.values():
        if len(df) < 2:  # Skipped subsets with fewer than 2 rows as insufficient for training
    ...
    # Decoded prediction columns and wrote results to CSV
